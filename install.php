...
?>';
        ...
        mysqli_query($conn, "ALTER TABLE `config` ADD `css_code` TEXT NOT NULL AFTER `homeurl`, ADD `maintenance` BOOLEAN NOT NULL AFTER `css_code`;") or die('Error!');
        mysqli_query($conn, "UPDATE `config` SET `maintenance` = '0' WHERE `config`.`id` = 1;") or die('Error!');
        $alert = '<p class="alert alert-success">Success! Click <a href="admin">here</a> to continue to your site</p>';
        unlink('install.php');
    }
}
...
if (file_exists('config.php')) {
    ...
    ?>
                                ...
                                <div class="card card-secondary">
                                    ...
                                    <div id="new" class="panel-collapse in collapse" style="">
                                        <div class="card-body">
