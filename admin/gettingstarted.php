                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="gettingstarted.php" class="nav-link active">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>3) Then go to <a href="config.php">Configuration</a> and replace name, logo, favicon etc. with your preferred one's.</p>
                                        <p>4) You can add tutorials at the the <a href="tutorials.php">Tutorials Section</a></p>
